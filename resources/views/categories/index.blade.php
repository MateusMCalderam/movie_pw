            ...
            <div class="admin-card rounded-xl p-6 mb-8">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <a href="{{ route('admin.categories.create') }}"
                        class="icon-button admin-button px-6 py-3 rounded-full font-semibold text-white hover:scale-105 transform transition-all duration-300 shadow-lg">
            ...
            <div class="admin-card rounded-xl p-6">
                @if($categories->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <a href="{{ route('admin.categories.create') }}"
                            class="icon-button admin-button px-8 py-3 rounded-full font-semibold text-white hover:scale-105 transform transition-all duration-300 shadow-lg">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            </svg>
                                    ...
                                    <div class="flex items-center space-x-2 ml-4">
                                        ...
                                        <form id="deleteForm" method="POST"
                                            action="{{ route('admin.categories.destroy', $category) }}"">
                                                        ...
                                                        @method('DELETE')
                                                <button 
                                                    class=" icon-button inline-flex items-center px-3 py-2 border
                                            border-red-500/30 text-red-400 bg-red-500/10 rounded-md text-sm font-medium
